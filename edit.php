...
<?php
    ...
    $id= "";$name = "";$gender = "";$phone = "";$currencyRiel="";$currencyDollar="";
    ...
    if($_SERVER['REQUEST_METHOD'] == 'GET'){
        ...
        $gender = $row["gender"];
        $phone = $row["phone"];
        $currencyRiel = $row["currency_riel"];
        $currencyDollar = $row["currency_dollar"];
        ...
        do{
            if(empty($name) || empty($gender) || empty($phone) || empty($currencyRiel) || empty($currencyDollar) || empty($address)){
                $errorMessage = "All the fileds are requied";
                break;
            }
            $sql = "UPDATE guests SET guest_name='$name',gender='$gender',phone='$phone',currency_riel='$currencyRiel',currency_dollar='$currencyDollar',guest_address='$address',
                update_at='$update_at' WHERE guest_id=$id";
